...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-background">
      {/* Subtle background patterns with colors from Playbook */}
      ...
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_800px_at_70%_70%,#1e40af,transparent)] opacity-10"></div>
