...
export function StrategyBuilder() {
  ...
  return (
    <Card className="border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden">
      <CardHeader className="border-b border-white/10 bg-gradient-to-r from-cyan-900/30 to-blue-900/30">
      ...
      <CardContent className="p-6">
        {!showResult ? (
            ...
            <div className="w-full max-w-3xl space-y-4">
              <div className="bg-white/5 border border-white/10 p-4 rounded-xl">
                ...
                <Textarea
                  ...
                  className="min-h-[120px] w-full bg-transparent border border-white/10 rounded-lg p-3 text-sm focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/30 resize-none"
                  value={input}
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {[
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    size="sm"
                    className="bg-white/5 border-white/10 hover:bg-cyan-900/20 hover:border-cyan-500/30 text-xs"
              ...
              <div className="flex flex-col items-center mt-6">
                <Button 
                  ...
                  className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 min-w-[180px]"
                >
                  {isGenerating ? (
                    <>
                ...
                {isGenerating && (
                  <div className="w-full max-w-md mt-6">
                    <div className="relative h-2 overflow-hidden rounded-full bg-white/10">
                      <div className="absolute h-full bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full animate-pulse"></div>
                    </div>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-cyan-900/10 via-blue-900/20 to-cyan-900/10 rounded-xl border border-white/10 p-6 relative overflow-hidden">
              {/* Subtle glow effect in the background */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/10 rounded-full filter blur-3xl -z-10"></div>
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="space-y-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium flex items-center">
                          <LineChart className="h-4 w-4 text-cyan-400 mr-2" />
                          Risk Model
                        </h4>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <h4 className="text-sm font-medium flex items-center">
                          <TriangleAlert className="h-4 w-4 text-cyan-400 mr-2" />
                  ...
                  <div className="py-4">
                    <div className="bg-cyan-950/30 border border-cyan-500/20 rounded-lg p-3 flex items-start gap-3">
                ...
                <div className="md:w-[260px] flex-shrink-0 space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="w-8 h-4 bg-cyan-900/30 rounded-full flex items-center p-0.5">
