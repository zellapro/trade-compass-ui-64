...
export function ExecutionScanner() {
  return (
    <Card className="border-white/10 bg-black/40 backdrop-blur-xl overflow-hidden">
      <CardHeader className="border-b border-white/10 bg-gradient-to-r from-violet-900/30 to-fuchsia-900/30">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center text-lg">
            <Lightbulb className="mr-2 h-5 w-5 text-violet-400" />
          ...
          <div className="flex flex-col space-y-5">
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <Badge className="bg-violet-500/80 text-white">93% Accuracy</Badge>
              </div>
              
              <div className="bg-gradient-to-r from-violet-900/20 to-violet-800/10 rounded-lg p-3 mb-4 border border-violet-500/20">
                <h4 className="text-xl font-bold bg-gradient-to-r from-violet-400 to-fuchsia-400 bg-clip-text text-transparent">
                  Rule-Bound Operator
                </h4>
              ...
              <div className="space-y-3">
                ...
                <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-full" style={{ width: "86%" }}></div>
                </div>
                ...
                <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-full" style={{ width: "72%" }}></div>
                </div>
                ...
                <div className="h-1.5 w-full bg-white/10 rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-full" style={{ width: "94%" }}></div>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
              ...
              <div className="space-y-3">
                <div className="flex items-start p-2 bg-green-900/20 border border-green-500/20 rounded-lg">
                ...
                <div className="flex items-start p-2 bg-amber-900/20 border border-amber-500/20 rounded-lg">
                ...
                <div className="flex items-start p-2 bg-red-900/20 border border-red-500/20 rounded-lg">
            ...
            <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
                {["Plan Adherence", "Timing Precision", "Post-Loss Recovery", "Impulse Control", "Checklist Usage"].map((metric, i) => (
                  <div key={i} className="flex flex-col items-center justify-center p-3 bg-white/5 rounded-lg border border-white/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="p-4 bg-white/5 border border-white/10 rounded-xl">
                <h3 className="font-medium mb-4 flex items-center">
                  <PieChart className="h-4 w-4 text-violet-400 mr-2" />
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="p-3 bg-amber-900/20 border border-amber-500/20 rounded-lg text-center">
                  ...
                  <div className="p-3 bg-red-900/30 border border-red-500/30 rounded-lg text-center">
                    <div className="text-xs text-muted-foreground mb-1">Impulsive Loss</div>
                    <div className="text-2xl font-bold text-red-500">10%</div>
                  </div>
                </div>
                
                <div className="mt-3 p-2 bg-violet-900/20 border border-violet-500/20 rounded-lg">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-xs">
                      ...
                      <span className="text-green-400 font-medium"> 59% win rate</span>, while impulsive decisions result in only a 
                      <span className="text-amber-400 font-medium"> 31% win rate</span>.
                    </p>
                  </div>
                </div>
              </div>
